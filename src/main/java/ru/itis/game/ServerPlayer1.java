...
public class ServerPlayer1 extends Player {
    Input input = JavaFXApplication.getInstance().getWorld().getInput();
    Image image_r = new Image(Main.class.getResourceAsStream("/images/player1_r.png"));
    Image image_l = new Image(Main.class.getResourceAsStream("/images/player1_l.png"));
    private float speed = 300.f;
    private double direction = 2;



    public ServerPlayer1(int id, boolean isCurrentPlayer) {
